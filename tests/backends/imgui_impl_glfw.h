...
// is called. GLFW callbacks will be installed for you. They will chain-call user's
// previously installed callbacks, if any.
// - When calling Init with 'install_callbacks=false': GLFW callbacks won't be
// installed. You will need to call individual function yourself from your own GLFW
// callbacks.
